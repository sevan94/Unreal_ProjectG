...
namespace PGGameplayTags
{
    ...
    UNREAL_PROJECTG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Combat_Skill_WeaponSharedSkill);
    UNREAL_PROJECTG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Combat_Skill_WeaponUniqueSkill);
    ...
    UNREAL_PROJECTG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_Set_RockStar);
    UNREAL_PROJECTG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Equipment_Set_DevilBat);
    ...
    UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_SVFX_Static);

    UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_SVFX_Actor);
}
