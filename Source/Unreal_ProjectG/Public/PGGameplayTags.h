...
namespace PGGameplayTags
{
    ...
    UNREAL_PROJECTG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Trigger_OnSkillPresentation);
    UNREAL_PROJECTG_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Trigger_OnTargetDataReady);
